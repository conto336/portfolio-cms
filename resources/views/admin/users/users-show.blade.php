            ...
            <table id="electronica" class="table table-striped dt-responsive nowrap" style="width:100%">
                ...
                <tbody id="tableElectronica">
                    @foreach ($userElectronica as $user)
                        <tr>
                            <td>
                                <p class="text-mute"> <img class="head"
                                        src="{{ asset('images/user.png') }}" alt="file" width="30" />
                                    {{ $user->name }}
                                </p>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="First group">
                                    <form action="{{ route('admin.edit-user', $user->id) }}" method="GET">
                                        <div class="mx-1">
