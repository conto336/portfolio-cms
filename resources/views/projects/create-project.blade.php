...
@section('title', 'Crear nuevo Projecto')
...
@section('header')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Agregar Projecto</h2>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form id="project" action="{{ route('create.project.store') }}" method="POST"
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" id="slug" name="slug" class="form-control"
                                            placeholder="ingrese-el-slug" value="{{ old('slug') }}" />
                                    </div>
                                    @error('slug')
                                        <x-alert-danger>
                                            {{ $message }}
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" id="github" name="github" class="form-control"
                                            placeholder="url repositorio" value="{{ old('github') }}" />
                                    </div>
                                    @error('github')
                                        <x-alert-danger>
                                            {{ $message }}
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" id="customer" name="customer" class="form-control"
                                            placeholder="Cliente del Proyecto" value="{{ old('customer') }}" />
                                    </div>
                                </div>
