...
Route::middleware(['auth:sanctum', 'verified'])->get('',  [AdminController::class, 'index'])
    ->name('admin.home');
...
Route::middleware(['auth:sanctum', 'verified', 'admin'])->post('show/update/user={id}',  [AdminController::class, 'update'])
...
Route::middleware(['auth:sanctum', 'verified'])->get('show/files/electronica',  [DocumentController::class, 'renderFilesElectronic'])
    ->name('admin.files-electronic');

Route::middleware(['auth:sanctum', 'verified'])->get('show/files/geologia',  [DocumentController::class, 'renderFilesGeology'])
    ->name('admin.files-geology');

Route::middleware(['auth:sanctum', 'verified'])->get('show/files/industrial',  [DocumentController::class, 'renderFilesIndustrial'])
    ->name('admin.files-industrial');

Route::middleware(['auth:sanctum', 'verified'])->get('upload/files',  [DocumentController::class, 'create'])
    ->name('admin.file-upload');

Route::middleware(['auth:sanctum', 'verified'])->get('edit/files/id={id}&name={name}',  [DocumentController::class, 'edit'])
